package tse_2021.practico1.test;
...
public class SampleIT {
    ...
    public static Archive<?> getEarArchive() {
        ...
        // and enter the "practico1-ejb" project.
        // The ejb jar is found in the "target" directory:
        File f = new File("../practico1-ejb/target/practico1-ejb.jar");
        ...
        war.addPackage("tse_2021.practico1.test");
